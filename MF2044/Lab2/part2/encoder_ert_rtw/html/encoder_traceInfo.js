...
Generator */
	...
	/* <S1>/Integral Gain */
	this.urlHashMap["encoder:15:1683"] = "encoder.c:97&encoder.h:106&encoder_data.c:26";
	/* <S1>/Integrator */
	this.urlHashMap["encoder:15:1684"] = "encoder.c:64,96,209&encoder.h:90,130,133&encoder_data.c:50,53";
	/* <S1>/Proportional Gain */
	this.urlHashMap["encoder:15:1682"] = "encoder.c:65&encoder.h:112&encoder_data.c:32";
	/* <S1>/Saturate */
	this.urlHashMap["encoder:15:1685"] = "encoder.c:70,79&encoder.h:83,109,115&encoder_data.c:29,35";
	/* <S1>/Sum */
	this.urlHashMap["encoder:15:1681"] = "encoder.c:63";
...
function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<S1>/Integral Gain"] = {sid: "encoder:15:1683"};
	this.sidHashMap["encoder:15:1683"] = {rtwname: "<S1>/Integral Gain"};
	this.rtwnameHashMap["<S1>/Integrator"] = {sid: "encoder:15:1684"};
	this.sidHashMap["encoder:15:1684"] = {rtwname: "<S1>/Integrator"};
	this.rtwnameHashMap["<S1>/Proportional Gain"] = {sid: "encoder:15:1682"};
	this.sidHashMap["encoder:15:1682"] = {rtwname: "<S1>/Proportional Gain"};
	this.rtwnameHashMap["<S1>/Saturate"] = {sid: "encoder:15:1685"};
	this.sidHashMap["encoder:15:1685"] = {rtwname: "<S1>/Saturate"};
	this.rtwnameHashMap["<S1>/Sum"] = {sid: "encoder:15:1681"};
	this.sidHashMap["encoder:15:1681"] = {rtwname: "<S1>/Sum"};
