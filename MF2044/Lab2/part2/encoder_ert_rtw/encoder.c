...
void encoder_step(void)
{
  ...
  /* S-Function (EncoderBlock): '<Root>/S-Function Builder1' */
  EncoderBlock_Outputs_wrapper(&encoder_B.SFunctionBuilder1,
  ...
  /* Update for S-Function (EncoderBlock): '<Root>/S-Function Builder1' */

  /* S-Function "EncoderBlock_wrapper" Block: <Root>/S-Function Builder1 */
  EncoderBlock_Update_wrapper(&encoder_B.SFunctionBuilder1,
    &encoder_DW.SFunctionBuilder1_DSTATE);
...
void encoder_initialize(void)
{
  ...
  /* External mode info */
  encoder_M->Sizes.checksums[0] = (2685624198U);
  encoder_M->Sizes.checksums[1] = (2470U);
  encoder_M->Sizes.checksums[2] = (2809351495U);
  encoder_M->Sizes.checksums[3] = (2048722810U);
  ...
  /* InitializeConditions for S-Function (EncoderBlock): '<Root>/S-Function Builder1' */
